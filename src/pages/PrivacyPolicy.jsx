...
const PrivacyPolicy = () => {
  return (
    <>
      <h1 className="mt-3">Privacy Policy for FastLED Animator</h1>

      <p>
        At fastledanimator.com, accessible from www.fastledanimator.com, one of
        ...
        fastledanimator.com and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in fastledanimator.com. This policy is not
      ...
      <p>
        fastledanimator.com follows a standard procedure of using log files.
      ...
      <p>
        Like any other website, fastledanimator.com uses 'cookies'. These
      ...
      <p>
        ...
        advertising partners of fastledanimator.com.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on fastledanimator.com, which are
      ...
      <p>
        Note that fastledanimator.com has no access to or control over these
      ...
      <p>
        fastledanimator.com's Privacy Policy does not apply to other advertisers
      ...
      <p>
        fastledanimator.com does not knowingly collect any Personal Identifiable
